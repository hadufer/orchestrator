...
- Navigate code with LSP when available (go-to-definition, find references, document/workspace symbols, diagnostics) to trace callers, implementations and types — not grep/Read alone. Fall back to text search where no LSP covers the language.
